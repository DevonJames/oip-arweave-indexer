...
const { fetchNutritionalData } = require('../../helpers/alexandria/nutritional-helper');
...
router.post('/newRecipe', async (req, res) => {
    // Import job tracker
    const { createJob, updateProgress, completeJob, failJob } = require('../../helpers/alexandria/jobTracker');
...
async function processRecipeAsync(jobId, reqBody, user) {
    const { updateProgress, completeJob, failJob } = require('../../helpers/alexandria/jobTracker');
