...
const { ongoingDialogues } = require('../../helpers/core/sharedState');
const { authenticateToken } = require('../../helpers/utils'); // Import the authentication middleware
const fs = require('fs');
const crypto = require('crypto');  // For generating a unique hash
const path = require('path');
const { generateCombinedSummaryFromArticles, replaceAcronyms, synthesizeSpeech, transcribeAudio, generateStreamingResponse, streamTextToSpeech, getElevenLabsVoices, streamChunkedTextToSpeech, flushRemainingText, generateRecipeImage } = require('../../helpers/core/generators');
const { generatePodcastFromArticles, generateInvestigativeReportFromDocuments, synthesizeDialogueTurn, getAudioDuration, personalities, convertDidTxRecordsToArticles } = require('../../helpers/alexandria/podcast-generator');
        ...
        (async () => {
            try {
                ...
                let personalitySettings = {
                    ...
                    model: "grok-4",
                    temperature: 0.7,
                    systemPrompt: "You are ALFRED (Autonomous Linguistic Framework for Retrieval & Enhanced Dialogue), a versatile and articulate AI assistant. You help a high-profile content creator stay informed and productive by answering questions, retrieving information from stored records, summarizing documents, and generating useful content such as custom podcasts about articles the content creator choses or segment outlines for his show. You prioritize clarity, speed, and relevance. IMPORTANT: Do not use emojis, asterisks, or other markdown formatting in your responses, as they interfere with text-to-speech synthesis.",
